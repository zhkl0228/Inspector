 ...
 * {@link #install(File, String, ClassLoader)}.
 *
 * <p/>
...
public final class MultiDex {
    ...
    private static final String SECONDARY_FOLDER_NAME = "inspector-plugin-dexes";
     ...
     *         extension.
     */
    public static void install(File filesDir, String apkPath, ClassLoader loader) {
        Log.i(TAG, "install");
        if (IS_VM_MULTIDEX_CAPABLE) {
            Log.i(TAG, "VM has multidex support, MultiDex support library is disabled.");
            try {
                clearOldDexDir(filesDir, apkPath);
            } catch (Throwable t) {
        ...
        try {
            synchronized (installedApk) {
                ...
                File dexDir = new File(filesDir, SECONDARY_FOLDER_NAME);
                List<File> files = MultiDexExtractor.load(apkFile, dexDir);
    ...
    private static void clearOldDexDir(File filesDir, String apkPath) throws Exception {
        synchronized (installedApk) {
            if (installedApk.contains(apkPath)) {
                return;
            }
