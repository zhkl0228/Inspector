// $ANTLR 3.5.2 smaliParser.g 2018-03-24 21:09:02
...
public class smaliParser extends Parser {
	...
	public final smaliParser.smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method, super_spec, class_spec, field, implements_spec, source_spec
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: annotation, member_name, access_list, nonvoid_type_descriptor, literal
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: literal, member_name, access_list, nonvoid_type_descriptor
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final smaliParser.method_return method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: access_list, member_name, statements_and_directives, method_prototype
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: registers_directive, ordered_method_item, catch_directive, parameter_directive, catchall_directive
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, signature, nonvoid_type_descriptor, NULL_LITERAL, name
	...
	public final smaliParser.insn_format20bc_return insn_format20bc() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: VERIFICATION_ERROR_TYPE, INSTRUCTION_FORMAT20bc, verification_error_reference
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format21s_return insn_format21s() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: integral_literal, INSTRUCTION_FORMAT21s, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format22s_return insn_format22s() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, REGISTER, integral_literal, instruction_format22s
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format35c_type_return insn_format35c_type() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: INSTRUCTION_FORMAT35c_TYPE, register_list, nonvoid_type_descriptor
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_reference, register_list, method_prototype, INSTRUCTION_FORMAT45cc_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
